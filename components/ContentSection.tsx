...
const content = () => {
  ...
  <div className="container mx-auto px-4">
    ...
    Trusted SEO Consultant in India
        ...
        <div className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 text-center  flex justify-center  items-center sm:justify-start dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 " href="/#contact">
                <CustomButton/>
