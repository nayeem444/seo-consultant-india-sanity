...
const MyBrands = () => {
  return (
    <section className="bg-[#25282C] text-white p-6 md:p-24">
      ...
      <div className="container mx-auto px-4 md:px-24 flex flex-col items-center">
        <h2 className="text-2xl md:text-3xl font-normal mb-4 md:mb-6 text-center">
          My Brands
        </h2>
        <h3 className="text-lg md:text-xl font-normal mb-2 md:mb-4 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-10">
          ...
          <div>
          <a 
          href='https://googlerankcheck.com'>
            <Image
