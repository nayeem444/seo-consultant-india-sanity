  ...
  return (
    <div className="flex flex-col md:flex-row"> {/* Flex container */}
      ...
      <div className="mx-4 md:mx-0 mt-4 md:mt-0 md:w-72"> {/* Apply margin and width */}
        <div className="rounded h-96 bg-blue-600 p-6 flex flex-col justify-center items-center"> {/* Side content */}
          <h1 className="text-white text-3xl font-bold mb-4 text-center">Let Us Handle Your SEO and Marketing</h1>
          <button 
            type="button" 
            className="text-black bg-white hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-white-600 dark:hover:bg-white-700 dark:focus:ring-white-800"
          >
            Book A Free Call
