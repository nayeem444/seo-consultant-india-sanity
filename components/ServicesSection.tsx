...
const Service = () => {
  return (
    <section id="services" className=" pb-12 -mt-24 dark:bg-dark lg:pb-[90px] max-w-8xl ">
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <g>
                    ...
                    <g>
                      ...
                      <g>
                        {' '}
                        <path d="M490.667,0H21.333C9.551,0,0,9.551,0,21.333v128v341.333C0,502.449,9.551,512,21.333,512h469.333 c11.782,0,21.333-9.551,21.333-21.333V149.333v-128C512,9.551,502.449,0,490.667,0z M42.667,42.667h426.667V128H42.667V42.667z M469.333,469.333H42.667V170.667h426.667V469.333z"></path>{' '}
                        <path d="M85.333,64C73.557,64,64,73.557,64,85.333s9.557,21.333,21.333,21.333s21.333-9.557,21.333-21.333S97.109,64,85.333,64z"></path>{' '}
                        <path d="M149.333,64C137.557,64,128,73.557,128,85.333s9.557,21.333,21.333,21.333s21.333-9.557,21.333-21.333 S161.109,64,149.333,64z"></path>{' '}
                        <path d="M213.333,64C201.557,64,192,73.557,192,85.333s9.557,21.333,21.333,21.333s21.333-9.557,21.333-21.333 S225.109,64,213.333,64z"></path>{' '}
                        <path d="M106.667,426.667h298.667c11.782,0,21.333-9.551,21.333-21.333V384c0-94.257-76.41-170.667-170.667-170.667 S85.333,289.743,85.333,384v21.333C85.333,417.115,94.885,426.667,106.667,426.667z M256,256c70.693,0,128,57.307,128,128 h-76.497l27.582-27.582c8.331-8.331,8.331-21.839,0-30.17c-8.331-8.331-21.839-8.331-30.17,0L247.163,384H128 C128,313.307,185.307,256,256,256z"></path>{' '}
                      </g>{' '}
                    </g>{' '}
                  </g>{' '}
                </g>
                  ...
                  <g>
                    ...
                    <g>
                      ...
                      <g>
                        <path
                          style={{ fill: '#fff' }}
                          d="M403.87,0H49.095C22.11,0,0,22.11,0,49.117v354.796c0,26.963,22.11,49.074,49.095,49.074H403.87 c27.007,0,49.117-22.11,49.117-49.074V49.117C452.986,22.11,430.876,0,403.87,0z M415.82,410.859H37.188V101.836H415.82V410.859z "
                        ></path>
                        <circle
                          style={{ fill: '#fff' }}
                          cx="124.765"
...
const ServiceCard = ({ icon, title, details }) => {
  return (
    <div className="w-full h-50 px-4 md:w-1/2 lg:w-1/3">
      <div className="mb-9 rounded-[20px] bg-white p-4 shadow-2 hover:shadow-lg dark:bg-dark-2 md:px-7 xl:px-10 flex flex-col items-center text-center">
        <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-black">
          {icon}
        </div>
        <h4 className="mb-[14px] text-2xl text-black">{title}</h4>
        <p>{details}</p>
      </div>
    </div>
  )
