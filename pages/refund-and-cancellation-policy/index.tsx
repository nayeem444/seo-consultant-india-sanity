              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-2">
                    <li>
                      <strong>Cancellation by Client:</strong> You may cancel your SEO consultation or management services by providing written notice via email. Cancellations must be made at least 7 days before the scheduled start date of the service.
                    </li>
                    <li>
                      <strong>Cancellation by Shahid Shahmiri:</strong> We reserve the right to cancel services if the client fails to meet payment obligations or violates our Terms and Conditions. In such cases, any payments made will not be refunded.
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-2">
                    <li>
                      <strong>Cancellation by Client:</strong> Custom SEO services are tailored to your needs and require significant preparation. Therefore, cancellations must be made within 5 days of signing the service agreement. Cancellations after this period will incur a fee equivalent to 50% of the total project cost.
                    </li>
                    <li>
                      <strong>Cancellation by Shahid Shahmiri:</strong> We may cancel the service if unforeseen circumstances prevent us from fulfilling the agreement. In such cases, you will receive a full refund of any payments made.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-2">
                    <li>
                      <strong>Non-Refundable Services:</strong> Due to SEO services, which involve extensive planning, research, and execution, refunds are generally not provided once the service has commenced.
                    </li>
                    <li>
                      <strong>Partial Refunds:</strong> If a client cancels a service before significant work has begun, a partial refund may be granted at our discretion. The refund amount will be calculated based on the work completed up to the cancellation date.
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-700 space-y-2">
                    <li>
                      <strong>Non-Refundable:</strong> All sales of digital products, such as SEO checklists, are final and non-refundable. This is due to the immediate access and irrevocable nature of digital goods.
                    </li>
                    <li>
                      <strong>Technical Issues:</strong> If you experience technical issues accessing or downloading a digital product, please contact us within 48 hours of purchase. We will work with you to resolve the issue or provide an alternative solution.
                    </li>
                  </ul>
                </div>
              </div>
